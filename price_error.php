...
<?php include 'topbar.php'; ?>
                ...
                <div class="container-fluid">
                    <h4 class="text-dark mb-4">ဝယ်ဈေးရောင်းဈေး အမှားစာရင်း</h4>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">ဝယ်ဈေးရောင်းဈေး တူနေသော ပစ္စည်းများနှင့် ဝယ်ဈေးထက် ရောင်း‌ဈေး နည်းနေသော ပစ္စည်းများစာရင်းဖြစ်သည်</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                ...
                                <table class="table table-hover table-sm my-0" id="tableNoStock">
                                    ...
                                    <tbody>
                                            <?php //product_id	product_name	category_id	
                                                ...
                                                WHERE selling_price < purchasing_price OR selling_price = purchasing_price
                                                ORDER BY purchasing_price DESC");
                                                $result->execute();
