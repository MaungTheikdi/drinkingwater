                                ...
                                <table class="table table-hover display nowrap text-nowrap table-sm my-0" style="width:100%" id="tablePurchaseReport">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"> ငှားရမ်းဗူး </th>
                                            <th class="text-center"> ပြန်ရဗူးခွံ </th>
                                            <th class="text-center"> ရရန်ကျန်ဗူးခွံ </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><?php echo $row['rent_no']; ?></td>
                                                    <td class="text-center"><?php echo $row['return_no']; ?></td>
                                                    <td class="text-center"><?php echo $row['new_rent_balance']; ?></td>
                                                </tr>
                                        <?php
                                        }
                                        ?>
